...
@section('content')
    ...
    <div class="row mb-3 mt-2">
        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion1" id="opcion1" @if($correspondencias->opcion1) checked @endif disabled>
            <label class="form-check-label" for="opcion1">PARA EL TRAMITE RESPECTIVO</label>
        </div>

        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion2" id="opcion2" @if($correspondencias->opcion2) checked @endif disabled>
    ...
    <div class="row mb-3">
        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion3" id="opcion3" @if($correspondencias->opcion3) checked @endif disabled>
            <label class="form-check-label" for="opcion3">PARA SU CONOCIMIENTO</label>
        </div>

        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion4" id="opcion4" @if($correspondencias->opcion4) checked @endif disabled>
    ...
    <div class="row mb-3">
        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion5" id="opcion5" @if($correspondencias->opcion5) checked @endif disabled>
            <label class="form-check-label" for="opcion5">SU ATENCION Y SEGUIMIENTO</label>
        </div>

        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion6" id="opcion6" @if($correspondencias->opcion6) checked @endif disabled>
    ...
    <div class="row mb-3">
        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion7" id="opcion7" @if($correspondencias->opcion7) checked @endif disabled>
            <label class="form-check-label" for="opcion7">ASISTIR E INFORMAR</label>
        </div>

        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion8" id="opcion8" @if($correspondencias->opcion8) checked @endif disabled>
    ...
    <div class="row mb-3">
        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion9" id="opcion9" @if($correspondencias->opcion9) checked @endif disabled>
            <label class="form-check-label" for="opcion9">ATENDER MARGINADO</label>
        </div>

        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion10" id="opcion10" @if($correspondencias->opcion10) checked @endif disabled>
    ...
    <div class="row mb-3">
        <div class="col-6"> 
            <input class="form-check-input" type="checkbox" name="opcion11" id="opcion11" @if($correspondencias->opcion11) checked @endif disabled>
            <label class="form-check-label" for="opcion11">PARA LOS EFECTOS PERTINENTES</label>
        </div>

        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion12" id="opcion12" @if($correspondencias->opcion12) checked @endif disabled>
    ...
    <div class="row mb-3">
        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion13" id="opcion13" @if($correspondencias->opcion13) checked @endif disabled>
            <label class="form-check-label" for="opcion13">ATENDER PETICION</label>
        </div>

        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion14" id="opcion14" @if($correspondencias->opcion14) checked @endif disabled>
    ...
    <div class="row mb-3">
        <div class="col-6">
            <input class="form-check-input" type="checkbox" name="opcion15" id="opcion15" @if($correspondencias->opcion15) checked @endif disabled>
